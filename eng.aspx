<%@ Page Title="About Us" Language="vb" MasterPageFile="~/Site.Master" AutoEventWireup="false"
    CodeBehind="eng.aspx.vb" Inherits="Mail_Gonder.About" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $("#Btn_Mail").click(strtBlackout); // open if btn is pressed
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    cellpadding="0" height="300" 
    style="font-family: 'Times New Roman'; letter-spacing: normal; orphans: 2; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-size-adjust: auto; -webkit-text-stroke-width: 0px; border: 1px solid rgb(192, 192, 192); padding: 1px 2px 1px 1px;" 
    width="740" align="center" border="1">
            ...
            <tr>
                <td colspan="2" height="18">
                    <p align="CENTER">
                        <font face="Tahoma">New Brand Compatible Laser Toner 
                Cartridge &amp; New Brand Compatible Inkjet Cartridge</font></p>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                ...
                style="text-align: center; vertical-align: top;">
                    ...
                    class="hps"><span lang="EN">Filling</span></span><span class="shorttext"><span 
                    lang="EN"><span class="Apple-converted-space">&nbsp;</span>and 
                Replacement Equipment Supplier</span></span></font></p>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    ...
                    <p align="CENTER">
                        <font face="Tahoma"><span 
                    style="color: blue;">Aktüel Computer Co., Ltd.</span></font></p>
                    </font>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    ...
                    <p align="CENTER">
                        <font face="Tahoma"><span 
                    style="color: blue;">Tex Invest Technology Foreign Trade Co.,</span></font></p>
                    </font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="8%">
                    <p align="left">
                        <font face="Tahoma"><strong><span class="style5">Phone</span></strong>&nbsp;&nbsp;&nbsp;</font></p>
                </td>
            ...
            <tr>
                <td width="8%" class="style6">
                    <p align="left" class="style11">
                        <font face="Tahoma" style="text-align: left">Fax&nbsp;</font></p>
                </td>
                <td class="style9" align="center">
            ...
            <tr>
                <td width="8%" class="style6">
                    <p align="left" class="style11">
                        <font face="Tahoma">E-mail</font></p>
                </td>
                <td class="style9" align="center">
                    <font face="Tahoma"><a 
